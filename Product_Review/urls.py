...
from productapp.views import login_view, home_view,update_mentor_project,admin_home,approve_product,problem_statement_approval,product_register, allocate_mentor, mentor_assignment_dashboard,product_details, product_update, about
...
urlpatterns = [
    ...
    path('about/', about, name='about'),  # About page
     path('update/<int:student_id>/', update_mentor_project, name='update_mentor_project'),
      # Logout
